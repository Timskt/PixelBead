...
const COLOR_TABLE: ColorEntry[] = [
  ...
  { name: "桃", dmc: "D4", hex: "#FFDAB9", r: 255, g: 218, b: 185 },
...
export function findNearestColor(r: number, g: number, b: number): ColorEntry {
  let minDist = Infinity
  let nearest = COLOR_TABLE[0]
...
export function getDmcCode(r: number, g: number, b: number): string {
  return findNearestColor(r, g, b).dmc
}
